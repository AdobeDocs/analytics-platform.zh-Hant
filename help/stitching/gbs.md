...
![身分識別服務](assets/uis-gbs.png){zoomable="yes"}
...
![身分識別圖表 3579](assets/identity-graphs.png)
...
當重播結合發生於2023-05-13 16:30，且回顧視窗設定為24小時時，會重新結合範例中的某些事件（由![重播](/help/assets/icons/Replay.svg)指示）。
