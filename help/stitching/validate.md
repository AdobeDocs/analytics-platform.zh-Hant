...
>[!IMPORTANT]
>
>本文說明如何驗證透過Adobe[請求的](/help/stitching/use-stitching.md)彙整，並使用新增至重複彙整資料集的彙整身分資料行實作。 已計畫儘快更新此文章，其中包含如何驗證透過Connections UI[啟用](/help/stitching/use-stitching-ui.md)的彙整功能的詳細資料。
