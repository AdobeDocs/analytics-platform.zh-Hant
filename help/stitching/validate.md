...
如需示範影片，請參閱![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [啟用及驗證](https://experienceleague.adobe.com/zh-hant/docs/customer-journey-analytics-learn/tutorials/visitor-id/stitching-enablement-and-validation){target="_blank"}。
...
1. 使用`stitchedID.namespace.code`欄位來建立&#x200B;**[!UICONTROL 電子郵件拼接名稱空間]**&#x200B;量度。 請確定您在元件設定](/help/data-views/component-settings/include-exclude-values.md)中指定[包含排除值，因此您只會考慮您嘗試將資料列提升到的名稱空間值。
