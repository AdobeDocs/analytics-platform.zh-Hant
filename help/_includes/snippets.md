...
* **60天**：回顧轉換發生後的60天。
* **90天**：回顧轉換發生後的90天。
* **13個月** [!BADGE B2B edition]{type=Informative}
...
* **全域帳戶（報告期間）** [!BADGE B2B edition]{type=Informative}
* **帳戶（報告期間）** [!BADGE B2B edition]{type=Informative}
* **機會（報告期間）** [!BADGE B2B edition]{type=Informative}
* **購買群組（報告期間）** [!BADGE B2B edition]{type=Informative}
...
>[!AVAILABILITY]
>
>本文所述的功能，以及任何其他徽章為[!BADGE B2B edition]的文章或功能{type=Informative}<br/>另外，[!BADGE B2B edition]{type=Informative}[!BADGE B2B edition]{type=Informative}<br/>此附註將在功能正式可用時移除。 如需Customer Journey Analytics發行程式的相關資訊，請參閱[Customer Journey Analytics功能發行](/help/release-notes/releases.md)。
>
