...
您無法同時收集使用者代理程式資訊和裝置查詢資訊；這些維度的母體是互斥的。 在[設定資料流](https://experienceleague.adobe.com/en/docs/experience-platform/datastreams/configure#geolocation-device-lookup)時，您必須選擇是要直接收集使用者代理程式，還是要收集裝置查閱資訊（根據使用者代理程式）。
