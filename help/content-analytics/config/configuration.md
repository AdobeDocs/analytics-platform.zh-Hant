...
* 如果您已使用Javascript](https://experienceleague.adobe.com/en/docs/experience-platform/web-sdk/install/library){target="_blank"}實作[網頁SDK以進行一般行為資料收集，請確定您使用的是預設名稱<code>alloy</code> （適用於Javascript程式庫）。
