...
您可以使用&#x200B;**[!UICONTROL 內容管道]**&#x200B;劃分為[劃分](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel)您感興趣的內容管道面板： **[!UICONTROL 網頁]**&#x200B;或&#x200B;**[!UICONTROL 行動裝置]**。

在Analysis Workspace的面板中，對內容頻道進行![劃分](/help/content-analytics/assets/aca-content-channel-selector.png)
