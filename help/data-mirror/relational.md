...
| 時間戳記 | id | pagename | personid | trackingcode | 訂單 | 收入金額 |
| :---                      |  ---: | :---              | :---            | :---          |   ---: | :---           |
...
1. 選取&#x200B;**[!UICONTROL 範例事件摘要結構描述]**&#x200B;旁的![AddCircle](/help/assets/icons/AddCircle.svg)，以開始將欄位新增至結構描述。 將具有資料型別和其他屬性的以下欄位新增到結構描述。
...
4. 在&#x200B;**[!UICONTROL 元件]**&#x200B;步驟：
   ...
   1. 將您要納入的任何結構欄位和/或標準元件新增至&#x200B;**[!UICONTROL 量度]**&#x200B;或&#x200B;**[!UICONTROL 維度]**&#x200B;元件框。 請確定您從包含映象資料的資料集中新增相關欄位。 若要存取這些欄位：
