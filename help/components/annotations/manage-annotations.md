...
編輯注釋意味著您可以調整日期範圍、顏色、範圍，或者它是否適用於所有資料視圖或項目。 編輯註解有兩個方法：
...
所有註解都使用時間戳記建立，但沒有「小時」或「時區」資訊。報表時，一律會套用面板資料檢視的時區。 因此，為聖誕節建立的附註會在12月25日發生 — 無論您處於哪個資料檢視時區。
...
| 篩選 (左側邊欄) | 依標籤、資料檢視、擁有者和其他篩選器（我的、已核准、我的最愛、已共用給我，以及全部顯示）進行篩選。 |
