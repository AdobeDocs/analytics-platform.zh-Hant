...
可在Customer Journey Analytics中使用&#x200B;**[!UICONTROL 元件]** > **[!UICONTROL 對象]**&#x200B;管理對象。
...
* 將insight增加到&#x200B;**從Customer Journey Analytics產生對象**&#x200B;所花的時間。 以及讓對象出現在即時客戶平台以供啟動所需的時間。
* 檢視Customer Journey Analytics中的對象是否被Real-time Customer Platform **主動使用**。 或（理想情況下）任何使用Customer Journey Analytics所建立對象的Experience Platform應用程式。

如果您有[對象檢視](/help/technotes/access-control.md#user-level-access)存取權，則可以檢視對象。 如果您有[對象建立](/help/technotes/access-control.md#user-level-access)存取權，您可以編輯和刪除對象。
...
| ![Delete](/help/assets/icons/Delete.svg) | **[!UICONTROL 刪除]** | 刪除選取的對象。 |
| ![Edit](/help/assets/icons/Edit.svg) | **[!UICONTROL 重新命名]** | 重新命名選取的對象。 使用&#x200B;**[!UICONTROL 重新命名： *對象名稱&#x200B;*]**對話方塊來重新命名對象，並選取**[!UICONTROL 儲存&#x200B;]**以儲存。 |
...
| ![Delete](/help/assets/icons/Delete.svg) | **[!UICONTROL 刪除]** | 刪除選取的對象。 |
| ![FileCSV](/help/assets/icons/FileCSV.svg) | **[!UICONTROL 匯出至 CSV]** | 將選取的對象匯出至名為`audiences.csv`的檔案。 |
