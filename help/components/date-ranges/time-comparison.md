...
1. 以滑鼠右鍵按一下資料表中的資料行，然後選取&#x200B;**[!UICONTROL 新增時段資料行]** ![以反白顯示新增時段資料行的資料表資料行清單](assets/add-time-period-column.png)
...
![含有表格設定的自由格式表格快顯功能表，顯示從每欄對齊日期，到所有開始日期都在選取的同一列。](assets/date-comparison-setting.png)
...
![顯示月對月百分比的比較。](assets/add-time-period-column3.png)
