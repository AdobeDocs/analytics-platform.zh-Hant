...
1. 選取&#x200B;**篩選器**&#x200B;圖示。
   ...
   ![位置頁面上的篩選圖示](assets/locations-filter-icon.png)
...
1. 選取&#x200B;[!UICONTROL **位置**]&#x200B;索引標籤。
   ...
   ![位置頁面](assets/locations-manager.png)
...
1. 選取&#x200B;[!UICONTROL **位置**]&#x200B;索引標籤。
   ...
   ![顯示[位置]索引標籤和位置清單的[匯出]視窗。](assets/locations-manager.png)

1. （視條件而定）如果您是系統管理員，可以啟用&#x200B;[!UICONTROL **檢視所有使用者的位置**]&#x200B;選項，以檢視組織中的所有使用者建立的位置。

1. 選取您要編輯的位置。

1. 選取畫面底部的&#x200B;[!UICONTROL **編輯**]。
...
1. 在您要編輯的帳戶上選取&#x200B;[!UICONTROL **編輯詳細資料**]。

1. 進行任何需要的變更，然後選取[儲存]。[!UICONTROL ****]

## 檢視帳戶金鑰

建立帳戶之後，您可以檢視該帳戶的任何關聯帳戶金鑰。 如果您在最初設定帳戶](/help/components/exports/cloud-export-accounts.md)時，尚未完成雲端提供者[的帳戶設定，您可能需要檢視此資訊。
...
1. 在您要編輯的帳戶上選取3點圖示，然後選取&#x200B;[!UICONTROL **顯示金鑰**]。
...
1. 選取要刪除之帳戶上的3點圖示，然後選取&#x200B;[!UICONTROL **刪除帳戶**]。
...
您可以限制使用者建立帳戶。 當您這樣做時，使用者仍然可以使用他們已建立的任何帳戶，但他們無法再編輯這些帳戶。 您可以刪除使用者已建立的帳戶，如[刪除帳戶](#delete-accounts)中所述。
...
1. （選擇性）刪除使用者已建立而您不再想要他們使用的任何帳戶，如[刪除帳戶](#delete-accounts)中所述。
...
您可以限制使用者建立位置。 當您這樣做，使用者仍然可以使用他們已建立的任何位置，但他們無法再編輯這些位置。 您可以刪除使用者已建立的位置，如[刪除位置](#delete-locations)中所述。
...
1. （選擇性）刪除使用者已建立而您不再希望他們使用的任何位置，如[刪除位置](#delete-locations)中所述。
...
1. 刪除帳戶，如[刪除帳戶](#delete-accounts)中所述。
