...
1. （視條件而定）如果您正在使用Azure儲存空間：
   ...
   1. 在Adobe Experience Platform中，設定您的資料登陸區域容器，以使用您複製的SAS URI。
      ...
      1. 在Adobe Experience Platform檔案中，請依照[將您的資料登陸區域容器連線至Azure儲存總管](https://experienceleague.adobe.com/docs/experience-platform/destinations/catalog/cloud-storage/data-landing-zone.html?lang=zh-Hant#connect-your-data-landing-zone-container-to-azure-storage-explorer)中所述的步驟操作。
