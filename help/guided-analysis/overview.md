...
| 分析類型 | 檢視類型 | 說明 |
| --- | --- | --- |
| [!UICONTROL 功能矩陣] | [參與](types/engagement.md) | 瞭解功能參與度的廣度和寬度。 |
