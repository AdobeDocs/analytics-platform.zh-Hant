...
* 如果任一資料集中只有部分事件有共同識別碼，您可以使用以下專案將資料彙整在一起 [拼接](/help/stitching/overview.md) 瞭解為這兩個資料集啟用跨管道分析的步驟。

## 在 Customer Journey Analytics 中建立連線

[建立連線](/help/connections/create-connection.md) 在Customer Journey Analytics中。
