...
* **LLM爬蟲**：收集資料，以便訓練和擷取增強產生(RAG)。
* **AI代理程式**：充當代表人類執行工作的介面。 AI代理程式偏好透過API互動，這略過網頁分析追蹤方法。 儘管如此，您仍可分析很大一部分透過網站的AI產生流量。

用於識別和監控LLM和AI產生流量的三種常見核心偵測方法如下：

* **使用者代理程式識別**：向伺服器提出要求時，會擷取HTTP User-Agent標頭，並根據已知的AI爬蟲和代理程式模式進行分析。 此伺服器端方法需要存取HTTP標題，且在資料收集層實作時最有效。
...
|---|---|---|---|
| **訓練模型** | 實作伺服器端記錄時，可以識別代理程式（`GPTBot`、`ClaudeBot`等）。 | 無法分類。 AI爬蟲在訓練期間不會產生反向連結。 | 偵測是不可能的。 AI爬蟲在訓練期間不會新增引數。 |
...
<td><a href="https://platform.openai.com/docs/bots/" target="_blank" rel="noopener nofollow noreferrer">OpenAI訓練ChatGPT和語言模型的主要網頁爬蟲</a></td>
</tr>
<tr>
...
<td><a href="https://platform.openai.com/docs/bots/" target="_blank" rel="noopener nofollow noreferrer">ChatGPT以搜尋為中心的爬蟲，用於探索內容</a></td>
</tr>
<tr>
...
<td><a href="https://support.claude.com/en/articles/8896518-does-anthropic-crawl-data-from-the-web-and-how-can-site-owners-block-the-crawler" target="_blank" rel="noopener nofollow noreferrer">Anthropic訓練和更新Claude AI助理的爬蟲</a></td>
</tr>
<tr>
...
<td><a href="https://docs.perplexity.ai/guides/bots" target="_blank" rel="noopener nofollow noreferrer">Perplexity.ai的即時Web資料索引爬蟲</a></td>
</tr>
<tr>
...
<td><a href="https://blog.google/technology/ai/an-update-on-web-publisher-controls/" target="_blank" rel="noopener nofollow noreferrer">Google的Gemini人工智慧專用爬蟲與標準GoogleBot分開</a></td>
</tr>
<tr>
...
<td>Microsoft的爬蟲支援Bing Search和Bing Chat (Copilot)</td>
</tr>
<tr>
...
<td>在You.com的AI 搜尋和瀏覽器助理後面爬蟲</td>
</tr>
<tr>
...
<td><a href="https://developer.amazon.com/amazonbot" target="_blank" rel="noopener nofollow noreferrer">Amazon的搜尋和AI應用程式爬蟲</a></td>
</tr>
<tr>
...
<td><a href="https://support.apple.com/en-us/119829" target="_blank" rel="noopener nofollow noreferrer">Apple的聚焦、Siri和Safari爬蟲</a></td>
</tr>
<tr>
...
<td><a href="https://support.apple.com/en-us/119829" target="_blank" rel="noopener nofollow noreferrer">Apple針對未來AI模型的AI聚焦爬蟲（選擇加入）</a></td>
</tr>
<tr>
