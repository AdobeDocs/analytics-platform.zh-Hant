...
Analysis Workspace將Orangey的第二集歸因於搜尋字詞`kids show`，而不考慮來自其他設定檔的搜尋。
...
>[!MORELIKETHIS]
>
>[在資料檢視中繫結Dimension](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/data-views/binding-dimensions-in-data-views.html?lang=zh-Hant)教學課程。
