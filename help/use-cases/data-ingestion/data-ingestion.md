...
1. [在標籤](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/sdk/overview.html?lang=zh-Hant)中設定Adobe Experience Platform Web SDK擴充功能，以透過Adobe Experience CloudEdge Network，從網頁屬性傳送資料至Adobe Experience Platform。
