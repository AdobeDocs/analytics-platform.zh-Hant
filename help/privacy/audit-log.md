...
| 使用者名稱 | 執行動作的使用者。 |
| 元件類型 | 可能的元件類型包括： <ul><li>註解</li><li>對象</li><li>計算量度</li><li>連線</li><li>資料群組</li><li>資料檢視</li><li>功能存取</li><li>篩選器</li><li>IMS 組織</li><li>行動</li><li>專案</li><li>報表</li><li>已排程專案</li><li>使用者</li><li>使用者群組</li></ul> |
...
| [!UICONTROL 元件類型] | 篩選一個或多個元件類型： <ul><li>註解</li><li>對象</li><li>計算量度</li><li>連線</li><li>資料群組</li><li>資料檢視</li><li>功能存取</li><li>篩選器</li><li>IMS 組織</li><li>行動</li><li>專案</li><li>報表</li><li>已排程專案</li><li>使用者</li><li>使用者群組</li></ul> |
