...
+ 升級和比較 {#compare-aa-cja}
  ...
  + 從Google Analytics 4轉換 {#ga-to-cja}
    + [概觀](/help/getting-started/ga-to-cja/home.md)
    + [資料模型](/help/getting-started/ga-to-cja/data-model.md)
    + [報表等值](/help/getting-started/ga-to-cja/reports.md)
    + [資料差異](/help/getting-started/ga-to-cja/compare-data.md)
...
+ 連線 {#cja-connections}
  ...
  + 同意報表和篩選 {#consent-reporting-filtering}
    + {hide-from-toc}[概觀](/help/connections/consent-reporting-filtering/consent-overview.md)
    ...
    + {hide-from-toc}[使用案例](/help/connections/consent-reporting-filtering/consent-use-cases.md)
+ 資料檢視 {#cja-dataviews}
  ...
  + 元件設定 {#component-settings}
    ...
    + {hide-from-toc}[範圍](/help/data-views/component-settings/scope.md)
...
+ Workspace 專案 {#cja-workspace}
  ...
  + 視覺效果 {#visualizations}
    ...
    + 自由格式表格 {#freeform-table}
      ...
      + [包括多個維度](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)
...
+ 拼接 {#stitching}
  ...
  + B2B {#b2b}
    + {hide-from-toc}[帳戶拼接人員](/help/stitching/b2b/b2b-person-to-account-stitching.md)

+ 母體報表總數 {#tpr}
  + {hide-from-toc}[概觀](/help/tpr/tpr.md)
  + {hide-from-toc}[共用查詢](/help/tpr/shared-lookups.md)
...
+ 技術說明 {#technotes}
  ...
  + [瀏覽器和語言](/help/technotes/browser-language.md)
...
+ [Customer Journey Analytics MCP伺服器](https://developer.adobe.com/analytics-mcp/docs/cja/)
