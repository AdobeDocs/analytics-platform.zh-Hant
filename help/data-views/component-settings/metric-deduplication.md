...
| [!UICONTROL 重複資料刪除範圍] | 可讓您決定不重複檢查追溯到多遠。<br/>**[!UICONTROL 全域帳戶&#x200B;]**：只計算報表時段中第一個量度發生次數。<br/>**[!UICONTROL 帳戶]**：只計算報表時段中第一個量度發生次數。<br/>**[!UICONTROL 機會&#x200B;]**：只計算報表時段中第一個量度發生次數。<br/>**[!UICONTROL 購買群組]**：只計算報表時段中第一個量度發生次數。<br/>**[!UICONTROL 人員&#x200B;]**：只計算報表時段中第一個量度發生次數。<br>**[!UICONTROL 工作階段]**：只計算工作階段中第一個量度發生次數。<br> |
