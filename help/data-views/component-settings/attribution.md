...
* **60天**：回顧轉換發生後的60天。
* **90天**：回顧轉換發生後的90天。
* **工作階段**：回顧到轉換發生的工作階段開始。 工作階段回顧期間遵循修改的[工作階段逾時](../create-dataview.md#session-settings)。
