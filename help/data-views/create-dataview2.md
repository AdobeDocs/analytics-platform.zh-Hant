...
此設定允許您在查詢時修改要報告的基礎資料。 它與篩選器不同。 但篩選器會尊重這個新維度，路徑和歸因也會如此。
...
| [!UICONTROL 符合] | 可讓您指定在歸因和篩選之前，您要考慮哪些值做報告（例如，僅使用包含片語「error」的值）。 您可以指定：**[!UICONTROL 如果滿足所有標準]**&#x200B;或&#x200B;**[!UICONTROL 如果滿足任何標準]**。 |
