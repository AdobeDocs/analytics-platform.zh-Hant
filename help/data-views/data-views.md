...
如果您[刪除[!UICONTROL Customer Journey Analytics]中的資料檢視](/help/data-views/manage-dataviews.md#delete-data-views)，則會出現錯誤訊息，指出與這個已刪除的資料檢視相依的任何[!UICONTROL Workspace]專案都不再運作。
