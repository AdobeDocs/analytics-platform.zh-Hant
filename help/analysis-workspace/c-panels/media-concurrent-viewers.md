...
*本文以&#x200B;**Customer Journey Analytics**記錄媒體同時檢閱者面板。 請參閱此文章的&#x200B;**Adobe Analytics**版本的[媒體同時檢閱者面板](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/media-concurrent-viewers)。*
