...
* **若要使用「與任何人共用」連結，於 Journey Optimizer 中進行變更後，需要將專案儲存在 Customer Journey Analytics 中**
  ...
  如需「與任何人共用」連結的詳細資訊，請參閱[共用專案](/help/analysis-workspace/curate-share/share-projects.md)中的[與任何人共用專案（不需要登入）](/help/analysis-workspace/curate-share/share-projects.md#share-a-project-with-anyone-no-login-required)。
