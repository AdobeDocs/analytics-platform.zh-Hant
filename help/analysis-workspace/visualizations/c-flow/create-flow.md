...
| [!UICONTROL 篩選欄] | 顯示的篩選選項與「自由格式」表格中的選項相同。 如需可用選項的詳細資訊，請參閱中的「將簡單或進階篩選器套用至表格」一節。 [篩選及排序表格](/help/analysis-workspace/visualizations/freeform-table/filter-and-sort.md). |
