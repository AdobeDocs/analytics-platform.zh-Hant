---
description: 瞭解如何指定觸點以建立多維度流失序列。
title: 設定流失視覺效果
...
您甚至可以在觸點中新增濾鏡。 例如，您可能想要比較篩選器，例如iOS和Android使用者。 將所要的篩選拖曳至流失的頂端，這些篩選的相關資訊就會新增至流失報表。 如果您只想顯示這些篩選，可以移除「所有瀏覽」基線。
...
1. 繼續新增接觸點，直到完成您的序列。
   ...
   >[!NOTE]
   >
   >多個篩選器與AND連結，但多個項目（例如維度項目和量度）與OR連結。
