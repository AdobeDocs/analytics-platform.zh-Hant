...
1. 在[篩選產生器](/help/components/filters/filter-builder.md)中，進一步編輯區段，然後按一下&#x200B;**[!UICONTROL 儲存]**。

   已儲存的區段可用於[!UICONTROL Analysis Workspace]的[!UICONTROL 篩選器]面板。
