...
如同Analysis Workspace中的其他視覺效果，您可以將「同類群組」視覺效果下載為CSV或PDF檔案。 如需詳細資訊，請參閱 [下載PDF或CSV檔案](/help/analysis-workspace/curate-share/download-send.md).