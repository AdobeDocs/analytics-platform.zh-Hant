...
請參閱 ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg)[「在自由格式表格中建立超連結」](https://experienceleague.adobe.com/zh-hant/docs/analytics-learn/tutorials/analysis-workspace/tips-and-tricks/create-hyperlinks-in-freeform-tables){target="_blank"}的示範影片。
