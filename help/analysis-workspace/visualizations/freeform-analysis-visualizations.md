...
| [長條圖](/help/analysis-workspace/visualizations/bar.md) <p>![條圖示](assets/Smock_GraphBarVertical_18_N.svg)</p> | 顯示代表一或多個量度多個值的垂直長條。 |
...
| [折線圖](/help/analysis-workspace/visualizations/line.md)<p>![行圖示](assets/Smock_GraphTrend_18_N.svg)</p> | 使用線條呈現量度，顯示一段時間內值的變化。線形圖會延 X 軸使用時間。 |
| [散點圖](/help/analysis-workspace/visualizations/scatterplot.md) <p>![散佈圖示](assets/Smock_GraphScatter_18_N.svg)</p> | 顯示維度項目與最多三個量度之間的關係。 |
