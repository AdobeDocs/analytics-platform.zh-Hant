...
| **行動應用程式使用情形** | 檢視應用程式上的使用者人數、啟動和首次啟動次數，以及平均工作階段長度。<p>**這可協助您**&#x200B;更清楚瞭解您的應用程式目前的使用量。 </p><p>**根據您的瞭解，您可能**&#x200B;會執行許多動作，例如改善應用程式效能，使其可擴充至使用量。</p><!-- This template uses the --> |
| **行動應用程式歷程** | 檢視行動應用程式的顯著使用模式。 <p>**這可協助您**&#x200B;更瞭解人們如何使用您的應用程式。 </p><p>**根據您所學到的內容，您可能**&#x200B;會做許多事情，例如改善人們在不同熒幕之間的互動方式，以鎖定最常見的工作流程。 </p><!-- This template uses the --> |
| **行動應用程式量度** | 檢視一些最常見的行動應用程式量度。 <p>**這可協助您**&#x200B;更瞭解行動應用程式的基本效能。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行任何工作，例如評估應用程式的整體健康狀況和效能。</p><!-- This template uses the --> |
| **行動應用程式訊息** | 檢視應用程式內訊息和推送訊息的效能資料。<p>**這可協助您**&#x200B;更瞭解使用者如何使用應用程式內傳訊功能，以及推播通知如何有效地將流量引導至您的應用程式。</p><p>**根據您的瞭解，您可能**&#x200B;會執行許多動作，例如改善應用程式內訊息推播通知體驗。</p><!-- This template uses the --> |
| **行動應用程式效能** | 檢視應用程式的執行狀況以及使用者遇到問題的位置。 <p>**這可協助您**&#x200B;更清楚瞭解使用您應用程式的人是否遇到效能緩慢或效能降低的問題。 </p><p>**根據您瞭解的情況，您可以**&#x200B;執行任何動作，例如在問題發生之前修正現有問題或改善應用程式效能。</p><!-- This template uses the --> |
| **行動應用程式保留率** | 檢視哪些使用者是您應用程式最忠實的使用者，以及他們在應用程式中的行為。 <p>**這可協助您**&#x200B;更瞭解您最忠實的使用者如何使用您的應用程式。</p><p>**根據您瞭解的情況，您可**&#x200B;執行許多動作，例如針對您最忠實的使用者所使用的功能，改善行銷工作。</p><!-- This template uses the --> |
...
>title="檢視您網站上的事件、工作階段和人員數量（以分鐘劃分）。 例如，如果您的報表具有單一天的報表時間範圍，則當天每小時的第一分鐘會分組到相同的維度專案中。"
>abstract="**這可協助您**&#x200B;更清楚瞭解趨勢。<br/>**根據您瞭解的情況，您可能**&#x200B;會執行許多操作，例如尖峰時段（精確到分鐘）的最佳化資源。<br/>此範本使用小時的分鐘維度。"
...
>title="檢視您網站上的事件、工作階段和人員（依一天中的小時劃分）。 例如，如果您的報表橫跨1月1日至1月7日，則每天的第一個小時都會分組到相同的維度專案中。"
>abstract="**這可協助您**&#x200B;更瞭解您網站最頻繁和最不常造訪的時間。<br/>**根據您瞭解的情況，您可能**&#x200B;會執行任何動作，例如在高流量時段為您的網站指派更多運算資源。<br/>此範本使用小時維度。"
...
>title="檢視您網站上的事件、工作階段和人員（依上午和下午劃分）。 例如，如果您的報表橫跨1月1日至1月7日，則每天的午時都會分組到相同的維度專案中。"
>abstract="***這可協助您**&#x200B;更瞭解您網站最頻繁和最不常造訪的時間。<br/>**根據您瞭解的情況，您可能**&#x200B;會執行任何動作，例如在高流量時段為您的網站指派更多運算資源。<br/>此範本使用AM/PM維度。"
...
>title="檢視您網站上的事件、工作階段和人員（依星期幾劃分）。 例如，如果您的報表橫跨1月，一週的每一天都會分組到相同的維度專案中。"
>abstract="**這可協助您**&#x200B;更清楚瞭解您的網站在一週中的哪幾天最常造訪且最不常造訪。<br/>**根據您所學到的內容，您可能**&#x200B;會做許多事情，例如在高流量日更適當地為客服中心配備人員。<br/>此範本使用星期維度。"
...
>title="檢視您網站上的事件、工作階段和人員（依月份中的日劃分）。 例如，如果您的報表橫跨全年，則當月的每一天都會分組到相同的維度專案中。"
>abstract="**這可協助您**&#x200B;更清楚瞭解您的網站每個月哪幾天最常造訪且造訪頻率最低。<br/>**根據您所學到的內容，您可能**&#x200B;會做許多事情，例如在高流量日更適當地為客服中心配備人員。<br/>此範本使用月份日期維度。"
...
>title="檢視您網站上的事件、工作階段和人員，依一年當中的第幾天劃分。 例如，如果您的報表橫跨多個年度，一年的每一天都會分組到相同的維度專案中。"
>abstract="**這可協助您**&#x200B;更瞭解您的網站每年哪幾天最常造訪且造訪頻率最低。<br/>**根據您所學到的內容，您可能**&#x200B;會做許多事情，例如在高流量日更適當地為客服中心配備人員。<br/>此範本使用一年中的日維度。"
...
>title="檢視您網站上的事件、工作階段和人員，依工作日和週末劃分。 例如，如果您的報表橫跨1月份，則平日和週末會分組為單獨的維度專案。"
>abstract="**這可協助您**&#x200B;更瞭解平日與週末的網站流量差異。<br/>**根據您瞭解的情況，您可能**&#x200B;會執行任何事情，例如週末您的客服中心更忙碌，如果報告指出週末比工作日忙的話。<br/>此範本使用工作日/週末維度。"
...
>title="檢視您網站上的事件、工作階段和人員，依一年當中的周數劃分。 例如，如果您的報表跨越多年，每週都會分組到相同的維度專案中。"
>abstract="**這可協助您**&#x200B;更清楚瞭解您的網站在一年中的哪些周最常造訪且最不常造訪。<br/>**根據您所學到的內容，您可能**&#x200B;會執行任何動作，例如在高流量周間（例如假期期間）更適當地為客服中心配備人員。<br/>此範本使用年度周維度。"
...
>title="檢視您網站上的事件、工作階段和人員，依月份劃分。 例如，如果您的報表跨越多年，則每個月都會分組到相同的維度專案中。"
>abstract="**這可協助您**&#x200B;更清楚瞭解您的網站最常造訪且最不常造訪的月份。<br/>**根據您所學到的內容，您可能**&#x200B;會執行任何動作，例如在高流量月份（例如假期期間）更適當地為客服中心配備人員。<br/>此範本使用月份維度。"
...
>title="檢視您網站上的事件、工作階段和人員，依季別劃分。 例如，如果您的報表跨越多年，則每個季度會分組到相同的維度專案中。"
>abstract="**這可協助您**&#x200B;更清楚瞭解您的網站最常造訪且造訪頻率最低的季度。<br/>**根據您所學到的內容，您可能**&#x200B;會執行許多動作，例如產品上市時間，以提升過去低流量的季數。<br/>此範本使用季別維度。"
...
| 範本名稱 | 為何使用此範本<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **分鐘小時**] | 檢視您網站上的事件、工作階段和人員數量（以分鐘劃分）。 例如，如果您的報表具有單一天的報表時間範圍，則當天每小時的第一分鐘會分組到相同的維度專案中。<p>**這可協助您**&#x200B;更清楚瞭解趨勢。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行許多操作，例如尖峰時段（精確到分鐘）的最佳化資源。</p><p>此範本使用小時的分鐘維度。</p> |
| **小時** | 檢視您網站上的事件、工作階段和人員（依一天中的小時劃分）。 例如，如果您的報表橫跨1月1日至1月7日，則每天的第一個小時都會分組到相同的維度專案中。<p>**這可協助您**&#x200B;更瞭解您網站最頻繁和最不常造訪的時間。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行任何動作，例如在高流量時段為您的網站指派更多運算資源。</p><p>此範本使用小時數維度。</p> |
| **上午/下午** | 檢視您網站上的事件、工作階段和人員（依上午和下午劃分）。 例如，如果您的報表橫跨1月1日至1月7日，則每天的午時都會分組到相同的維度專案中。<p>**這可協助您**&#x200B;更瞭解您網站最常造訪且最不常造訪的時間。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行任何動作，例如在高流量時段為您的網站指派更多運算資源。</p><p>此範本使用AM/PM維度。</p> |
| **星期** | 檢視您網站上的事件、工作階段和人員（依星期幾劃分）。 例如，如果您的報表橫跨1月，一週的每一天都會分組到相同的維度專案中。 <p>**這可協助您**&#x200B;更清楚瞭解您的網站在一週中的哪幾天最常造訪且最不常造訪。</p><p>**根據您所學到的內容，您可能**&#x200B;會做許多事情，例如在高流量日更適當地為客服中心配備人員。</p><p>此範本使用星期維度。</p> |
| **日期** | 檢視您網站上的事件、工作階段和人員（依月份中的日劃分）。 例如，如果您的報表橫跨全年，則當月的每一天都會分組到相同的維度專案中。 <p>**這可協助您**&#x200B;更清楚瞭解您的網站每個月哪幾天最常造訪且造訪頻率最低。</p><p>**根據您所學到的內容，您可能**&#x200B;會做許多事情，例如在高流量日更適當地為客服中心配備人員。</p><p>此範本使用月份日期維度。</p> |
...
| **平日/週末** | 檢視您網站上的事件、工作階段和人員，依工作日和週末劃分。 例如，如果您的報表橫跨1月份，則平日和週末會分組為單獨的維度專案。 <p>**這可協助您**&#x200B;更瞭解平日與週末的網站流量差異。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行任何事情，例如週末您的客服中心更忙碌，如果報告指出週末比工作日忙的話。</p><p>此範本使用工作日/週末維度。</p> |
| **年周** | 檢視您網站上的事件、工作階段和人員，依一年當中的周數劃分。 例如，如果您的報表跨越多年，每週都會分組到相同的維度專案中。<p>**這可協助您**&#x200B;更清楚瞭解您的網站在一年中的哪些周最常造訪且最不常造訪。</p><p>**根據您所學到的內容，您可能**&#x200B;會執行任何動作，例如在高流量周間（例如假期期間）更適當地為客服中心配備人員。</p><p>此範本使用周數維度。</p> |
| **月份** | 檢視您網站上的事件、工作階段和人員，依月份劃分。 例如，如果您的報表跨越多年，則每個月都會分組到相同的維度專案中。<p>**這可協助您**&#x200B;更清楚瞭解您的網站最常造訪且最不常造訪的月份。</p><p>**根據您所學到的內容，您可能**&#x200B;會執行任何動作，例如在高流量月份（例如假期期間）更適當地為客服中心配備人員。</p><p>此範本使用月份維度。</p> |
| **季別** | 檢視您網站上的事件、工作階段和人員，依季別劃分。 例如，如果您的報表跨越多年，則每個季度會分組到相同的維度專案中。<p>**這可協助您**&#x200B;更清楚瞭解您的網站最常造訪且造訪頻率最低的季度。</p><p>**根據您所學到的內容，您可能**&#x200B;會執行許多動作，例如產品上市時間，以提升過去低流量的季數。</p><p>此範本使用「季別」維度。</p> |
...
>title="檢視跨多個管道的流量分佈。"
>abstract="**這可協助您**&#x200B;更瞭解哪些頻道可更成功促進流量和參與。 <br/>**根據您所學到的內容，您可能**&#x200B;會執行許多動作，例如將行銷工作集中在獲得最高投資報酬率的管道上。<br/>此範本使用使用者、工作階段和事件量度。"
...
>title="檢視網路流量如何影響客服中心流量。"
>abstract="**這可協助您**&#x200B;更瞭解網站上的自助服務內容如何成功將流量導向您的客服中心。<br/>**根據您所學到的內容，您可能**&#x200B;會執行許多動作，例如增強自助服務內容以降低客服中心的流量，或透過減少支援電話的節省金額來衡量自助服務內容的ROI。<br/>此範本使用網頁工作階段、行動應用程式工作階段和Web+應用程式跨頻道工作階段量度。"
...
>title="一起檢視網站流量和行動流量。"
>abstract="**這可協助您**&#x200B;更清楚瞭解您網站的網頁和行動流量分佈。<br/>**根據您瞭解的情況，您可能**&#x200B;會做許多事情，例如當您的行動應用程式達到特定流量等級時，為您的行動應用程式體驗投入更多資源。<br/>此範本使用網頁工作階段、行動應用程式工作階段和Web+應用程式跨頻道工作階段量度。"
...
>title="同時檢視線上和離線流量。"
>abstract="**這可協助您**&#x200B;更清楚瞭解您網站的線上和離線流量分佈。<br/>**根據您的瞭解，您可能**&#x200B;會做許多事情，例如當您的線上體驗達到特定流量等級時，將更多資源專用於該體驗。"
...
| 範本名稱 | 為何使用此範本<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **多管道概觀**] | 檢視跨多個管道的流量分佈。 <p>**這可協助您**&#x200B;更瞭解哪些頻道可更成功促進流量和參與。 </p><p>**根據您所學到的內容，您可能**&#x200B;會執行許多動作，例如將行銷工作集中在獲得最高投資報酬率的管道上。</p><p>此範本使用使用者、工作階段和事件量度。</p> |
| **呼叫中心偏轉（Web+呼叫中心）** | 檢視網路流量如何影響客服中心流量。<p>**這可協助您**&#x200B;更瞭解網站上的自助服務內容如何成功將流量導向您的客服中心。</p><p>**根據您所學到的內容，您可能**&#x200B;會執行許多動作，例如增強自助服務內容以降低客服中心的流量，或透過減少支援電話的節省金額來衡量自助服務內容的ROI。</p><p>此範本使用網頁工作階段、行動應用程式工作階段和網頁與應用程式跨管道工作階段量度。</p> |
| **網頁+應用程式** | 一起檢視網站流量和行動流量。<p>**這可協助您**&#x200B;更清楚瞭解您網站的網頁和行動流量分佈。</p><p>**根據您瞭解的情況，您可能**&#x200B;會做許多事情，例如當您的行動應用程式達到特定流量等級時，為您的行動應用程式體驗投入更多資源。</p><p>此範本使用網頁工作階段、行動應用程式工作階段和網頁與應用程式跨管道工作階段量度。</p> |
| **線上/離線** | 同時檢視線上和離線流量。<p>**這可協助您**&#x200B;更清楚瞭解您網站的線上和離線流量分佈。</p><p>**根據您的瞭解，您可能**&#x200B;會做許多事情，例如當您的線上體驗達到特定流量等級時，將更多資源專用於該體驗。</p><!-- This template uses the ... --> |
...
>title="檢視Journey Optimizer促銷活動的重要量度，包括電子郵件促銷活動、實驗、應用程式內、SMS等。"
>abstract="**這可協助您**&#x200B;更清楚瞭解點按次數和傳送訊息數等詳細資訊，讓您更全面地瞭解行銷活動的成效和參與程度。<br/>**根據您學到的內容，您可能**&#x200B;會做許多事情，例如根據目標對象的參與層級調整您的行銷活動。"
...
>title="檢視Journey Optimizer歷程的基本量度，包括電子郵件歷程、實驗、應用程式內、簡訊等。"
>abstract="**這可協助您**&#x200B;更清楚瞭解點按次數和傳送訊息數等詳細資訊，讓您更全面地瞭解歷程的成效和參與程度。<br/>**根據您學到的內容，您可能**&#x200B;會做許多事情，例如根據目標對象的參與層級調整您的行銷活動。"
...
>abstract="**這可協助您**&#x200B;更瞭解登陸頁面的有效性。 <br/>**根據您的瞭解，您可能**&#x200B;會執行許多操作，例如最佳化您的登入頁面效能。"
...
>title="檢視您環境中所有行銷活動和歷程的流量和參與量度的完整摘要。"
>abstract="**這可協助您**&#x200B;更清楚瞭解行銷活動和歷程的高階成效。 <br/>**根據您學到的內容，您可能**&#x200B;會做許多事情，例如根據目標對象的參與層級調整您的行銷活動和歷程。"
...
>title="檢視設定檔的訂閱和與特定清單相關聯的取消訂閱。"
>abstract="**這可協助您**&#x200B;更瞭解不同訂閱行銷活動和方案在提高參與度和轉換率方面的成效。<br/>**根據您學到的內容，您可能**&#x200B;會做許多事情，例如根據目標對象的參與層級調整您的訂閱行銷活動。"
