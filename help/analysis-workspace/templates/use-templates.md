...
>title="檢視組織內使用Customer Journey Analytics產品的方式。"
>abstract="**這可協助您**&#x200B;更清楚瞭解有多少人正在使用Customer Journey Analytics、他們使用頻率以及隨著時間推移的使用趨勢。 您也可以檢視正在建立的專案數目，以及有關這些專案的詳細資訊（例如最常使用的元件、視覺效果和面板），以及其他許多使用統計資料。<br/>**根據您所學到的內容，您可以**&#x200B;執行任意數量的操作，例如刪除未使用的專案或元件，或提供使用者訓練以了解熱門功能。"
...
| **產品使用概述** （即將推出） | 檢視組織內使用Customer Journey Analytics產品的方式。 <p>**這可協助您**&#x200B;更清楚瞭解有多少人正在使用Customer Journey Analytics、他們使用頻率以及隨著時間推移的使用趨勢。 您也可以檢視正在建立的專案數目，以及有關這些專案的詳細資訊（例如最常使用的元件、視覺效果和面板），以及其他許多使用統計資料。</p><p>**根據您所學到的內容，您可以**&#x200B;執行任意數量的操作，例如刪除未使用的專案或元件，或提供使用者訓練以了解熱門功能。</p> |
