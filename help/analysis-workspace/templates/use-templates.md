...
>title="檢視與您網站上每個產品類別相關的造訪次數。如果您的實施作業使用產品變數，且您想要檢視產品類別的相關量度，此功能就十分實用。 如果您的網站上沒有任何產品，填入此範本的維度可能會刻意保留為空白。"
...
| **技術概覽** | 檢視與使用者用來存取網站的技術相關的資訊，例如作業系統、瀏覽器和裝置。 <p>**這有助於您**&#x200B;更了解存取您網站時最常使用的技術。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種動作，例如針對所使用的技術將您的網站最佳化。</p> |
