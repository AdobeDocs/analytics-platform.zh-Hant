...
>title="瞭解哪些內容和內容屬性成效最佳。"
>abstract="**這可協助您**&#x200B;瞭解您的內容在精細層次的執行狀況。 您可以檢視個別資產或特定屬性的效能。 Content Analytics會使用AI來自動產生屬性，並使用這些屬性標籤您的內容。 [了解更多](/help/content-analytics/content-analytics.md)。<br/>**根據您瞭解到的內容，您可能**&#x200B;會執行許多操作，例如在首頁上促銷高績效資產、個人化特定區段的內容以包含高績效屬性，或輪換已開始陳舊的內容。"
...
| **內容分析** | 瞭解哪些內容和內容屬性成效最佳。<p>**這可協助您**&#x200B;瞭解您的內容在精細層次的執行狀況。 您可以檢視個別資產或特定屬性的效能。 Content Analytics會使用AI來自動產生屬性，並使用這些屬性標籤您的內容。 [了解更多](/help/content-analytics/content-analytics.md)。</p><p>**根據您瞭解到的內容，您可能**&#x200B;會執行許多操作，例如在首頁上促銷高績效資產、個人化特定區段的內容以包含高績效屬性，或輪換已開始陳舊的內容。</p> |
