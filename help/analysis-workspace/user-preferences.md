...
| **專案註解** | | |
| | 允許評論專案 | 啟用此選項後，Analysis Workspace中每個專案的右側邊欄都會顯示一個註解區域。 <p>專案所有者可以停用指定專案的註解區域，如[建立專案](/help/analysis-workspace/build-workspace-project/create-projects.md)中所述。</p> <p>如需在Analysis Workspace專案中加上註解的詳細資訊，請參閱[在專案中新增及管理註解](/help/analysis-workspace/build-workspace-project/comment-projects.md)。</p> |
