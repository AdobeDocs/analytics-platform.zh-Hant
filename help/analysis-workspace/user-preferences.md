...
| 專案評論 | 允許評論專案 | **注意：**&#x200B;此功能處於發行的有限測試階段，可能尚未在您的環境中提供。 當該功能供一般用途時，此備註將被刪除。有關 Customer Journey Analytics 發佈流程的資訊，請參閱 [Customer Journey Analytics 功能發佈](/help/release-notes/releases.md)。 <p>啟用此選項後，Analysis Workspace中每個專案的右側邊欄都會顯示一個註解區域。</p> <p>專案所有者可以停用指定專案的註解區域，如[建立專案](/help/analysis-workspace/build-workspace-project/create-projects.md)中所述。</p> <p>如需在Analysis Workspace專案中加上註解的詳細資訊，請參閱[在專案中新增及管理註解](/help/analysis-workspace/build-workspace-project/comment-projects.md)。</p> |
