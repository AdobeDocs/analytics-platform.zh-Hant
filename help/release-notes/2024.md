...
| **Adobe Product Analytics：強化漏斗中的深入解析** | 在[漏斗](/help/guided-analysis/types/funnel.md)檢視中，已增強書面深入分析，以包含類別、增量與說明，以進一步瞭解圖表與表格。 | 2024 年 4 月 17 日 | 2024 年 4 月 26 日 |
| **Adobe Product Analytics：強化保留視圖** | 已在[保留率](/help/guided-analysis/types/retention.md)檢視中新增幾項功能，以推動更深入且可自訂的保留率深入分析：<ul><li>解除連結開始和返回事件</li><li>在單一視圖中比較多個返回事件</li><li>自訂已套用在或晚於 (未繫結)、每個 (繫結) 和階層分類設定的保留模型</li><li>顯示和隱藏圖表中的各個同類群組列</li></ul> | 2024 年 4 月 24 日 | 2024 年 5 月 8 日 |
| **Adobe Product Analytics：比較單一漏斗步驟中的事件** | 您現在可以在[漏斗](/help/guided-analysis/types/funnel.md)檢視的單一漏斗步驟中比較事件。 您的歷程有步驟選項或有一個執行 A/B 實驗的步驟時，此功能特別實用。 | 2024 年 4 月 23 日 | 2024 年 5 月 3 日 |
