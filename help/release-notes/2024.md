...
| ----------- | ---------- | ------- | ---- |
| **資產轉移** | 可讓您轉移專案、區段和計算量度等元件的擁有權給其他使用者，以確保持續性和適當的存取權。 [了解更多](/help/tools/asset-transfer/transfer-assets.md) |  | 15 年 10 月 |
| **引導式分析：嵌入在 Workspace 中** | [引導式分析](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/guided-analysis/overview)現在可以直接在 Analysis Workspace 中使用，讓使用者可以建立儀表板，呈現來自面板、視覺化呈現和引導式分析的全方位洞察。 從新的左邊欄區段，您可以建立新的引導式分析並新增至您的專案中。 您還可以存取已儲存的引導式分析，可以作為建置要素在許多專案中重複使用。 | 2024 年 10 月 2 日 | 2024 年 10 月 23 日 |
...
| ----------- | ---------- | ------- | ---- |
| **資產轉移** | 可讓您轉移專案、區段和計算量度等元件的擁有權給其他使用者，以確保持續性和適當的存取權。 [了解更多](/help/tools/asset-transfer/transfer-assets.md) |  | 15 年 10 月 |
| **引導式分析：嵌入在 Workspace 中** | [引導式分析](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/guided-analysis/overview)現在可以直接在 Analysis Workspace 中使用，讓使用者可以建立儀表板，呈現來自面板、視覺化呈現和引導式分析的全方位洞察。 從新的左邊欄區段，您可以建立新的引導式分析並新增至您的專案中。 您還可以存取已儲存的引導式分析，可以作為建置要素在許多專案中重複使用。 | 2024 年 10 月 2 日 | 2024 年 10 月 31 日 |
...
| **衍生欄位 - 數學函數** | 讓您在資料視圖中執行簡單的數學運算子，以便回答有關使用者的問題。 例如，您可以合併產品、保固和運送等營收。 <p>(更新的文件連結待補充)</p> | | 2024 年 6 月 5 日 |
...
| **Adobe Product Analytics：強化漏斗中的洞察** | 在「[漏斗](/help/guided-analysis/types/funnel.md)」視圖中，書面洞察已強化，以包括類別、增量和說明，從而進一步了解圖表和表格。 | 2024 年 4 月 17 日 | 2024 年 4 月 26 日 |
| **Adobe Product Analytics：強化保留視圖** | 「[保留](/help/guided-analysis/types/retention.md)」視圖中新增了多項功能，以推動更深入且可自訂的保留洞察：<ul><li>解除連結開始和返回事件</li><li>在單一視圖中比較多個返回事件</li><li>自訂已套用在或晚於 (未繫結)、每個 (繫結) 和階層分類設定的保留模型</li><li>顯示和隱藏圖表中的各個同類群組列</li></ul> | 2024 年 4 月 24 日 | 2024 年 5 月 8 日 |
...
| **管理員可以管理其組織中的所有位置和帳戶** | 「位置」標籤 (在「元件 > 匯出」頁面上) 上的新選項可以讓管理員檢視和管理組織中的所有位置。 <p>「位置」帳戶標籤 (在「元件 > 匯出」頁面上) 上的新選項可以讓管理員檢視和管理組織中的所有帳戶。</p><p>以前，管理員只能檢視和管理他們建立的位置和帳戶。</p> | | 2024 年 4 月 |
...
| 功能 | 說明 | [開始推出](releases.md) | [全面發佈](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **時間序列預測** | [預測](../analysis-workspace/c-forecast/forecasting.md)是 Analysis Workspace 的新功能，用於以任何支援的時間顆粒度 (每小時、每天、每週、每月和每年) 為自由格式表格和折線圖預測標準或計算量度。 | 2024 年 1 月 31 日 | 2024 年 2 月 21 日 |
...
| **時間序列預測** | [預測](../analysis-workspace/c-forecast/forecasting.md)是 Analysis Workspace 的新功能，可以自由格式表格和線圖支援的任何時間顆粒度 (每小時、每天、每週、每月和每年) 來預測標準或計算量度。 | 2024 年 1 月 31 日 | 2024 年 2 月 21 日 |
