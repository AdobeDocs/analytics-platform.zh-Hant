...
| **Edge網路裝置查詢** | 透過Experience Platform邊緣網路啟用自動裝置型別資料收集。 此服務可讓Customer Journey Analytics與其他Experience Platform應用程式共同受益。 [了解更多](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-device-lookup) | 不適用 | 2023 年 9 月 27 日 |
...
| **Edge Network地理查閱** | 您可以在Customer Journey Analytics中使用地理位置資料。 在資料流設定中啟用此功能。 [了解更多](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-network-lookup) |  | 2023 年 7 月 26 日 |
