---
title: 2023 年 Customer Journey Analytics 發行說明
description: 檢視 2023 年 Customer Journey Analytics 發行說明
...
# 2023 年 Customer Journey Analytics 發行說明
...
| **報告活動管理員** | 報告活動管理器可讓您查看組織中每個連線的報告產能。 它為管理員提供報告使用量的詳細可見度，以便在尖峰報告期間輕鬆診斷和修正產能問題。 報告活動管理器的主要功能包括：<ul><li>取消目前的報告請求 (包括引導式分析和完整表格匯出的請求)</li><li>限制已定義時段的後續請求</li></ul>除了取消目前的請求之外，管理員現在還可以限制定義時段內的請求。 管理員可依據請求、專案或使用者來限制請求。  [了解更多](/help/reporting-activity-manager/reporting-activity-overview.md) | 2023 年 10 月 24 日 | 2023 年 10 月 23 日 |
...
| **Edge Network 裝置查詢** | 透過 Experience Platform Edge Network 啟用自動裝置類型資料彙集。 此服務有利於 Customer Journey Analytics 以及其他 Experience Platform 應用程式。 [了解更多](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-device-lookup) | 不適用 | 2023 年 9 月 27 日 |
...
| **貨幣轉換** | Customer Journey 增加了支援多種貨幣的功能。 您可以在資料釋圖設定中將一種貨幣轉換為另一種貨幣。 [了解更多](/help/data-views/component-settings/format.md) | 不適用 | 2023 年 8 月 30 日 |
...
| 功能 | 說明 | [開始推出](releases.md) | [全面發佈](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **Adobe Journey Optimizer 資料檢視** | Customer Journey Analytics 管理員可以存取 Customer Journey Analytics 中一些額外的資料釋圖，標題為「AJO 資料釋圖 (沙箱名稱)」。 這些資料檢視是用來為 Adobe Journey Optimizer 的報告提供支援。 也可以用來在 Customer Journey Analytics 中，對 Adobe Journey Optimizer 活動執行更深入的分析。 [了解更多](https://experienceleague.adobe.com/zh-hant/docs/journey-optimizer/using/reporting/channel-report/reporting-configuration)。 | | 2023 年 5 月 25 日 |
...
| **在面板中新增視覺效果的新按鈕** | 現在，Analysis Workspace 每個面板的底部都有一個新按鈕，可讓您快速新增視覺效果。 <p>以前，將視覺效果新增到面板的唯一方法是從左側邊欄拖放視覺效果、重複或複製現有的視覺效果，或者建立空白面板。 [了解更多](/help/analysis-workspace/visualizations/freeform-analysis-visualizations.md)</p> | 不適用 | 2023 年 5 月 17 日 |
...
| 功能 | 說明 | [開始推出](releases.md) | [全面發佈](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **Adobe Journey Optimizer 資料檢視** | Customer Journey Analytics 管理員可以存取 Customer Journey Analytics 中一些額外的資料檢視，標題為「AJO 資料檢視 (沙箱名稱)」。 這些資料檢視是用來為 Adobe Journey Optimizer 的報告提供支援。 也可以用來在 Customer Journey Analytics 中，對 Adobe Journey Optimizer 活動執行更深入的分析。 [了解更多](https://experienceleague.adobe.com/zh-hant/docs/journey-optimizer/using/reporting/channel-report/reporting-configuration)。 | | 2023 年 5 月 25 日 |
| **非生產沙箱的回填** | 在非生產沙箱中建立 Analytics 來源連接器資料流時，會將非生產沙箱中的回填限制為 3 個月。 生產沙箱將維持 13 個月。 | 不適用 | 2023 年 4 月 26 日 |
...
| **Adobe Product Analytics - 僅限 Private Beta 存取權** | 2023 年 3 月 21 日，Adobe 宣布推出 Adobe Product Analytics，這是一種與 Customer Journey Analytics 跨管道資料和洞察進行互動的新方式。 這些新功能使產品團隊能夠透過引導式分析工作流程取得有關其產品體驗的自助資料和洞察。 團隊可以：<ul><li>了解一段時間內使用者參與模式&#x200B;</li><li>分析使用者群的增長</li><li>辨識一系列步驟中的摩擦區域&#x200B;</li><li>衡量功能發佈的影響&#x200B;</li><li>發現在產品整個歷程中可投入和培養的有意義巿場區間</li><li>在 Analysis Workspace 中開啟以進行更深入分析和與分析師協作等！</li></ul>如果您是 Customer Journey Analytics 客戶且有興趣加入 Private Beta，請聯絡您的 Adobe 帳戶團隊。 [了解更多](https://business.adobe.com/products/product-analytics/adobe-product-analytics.html) | 不適用 | 2023 年 7 月 17 日 |
...
| 已排程專案的過期日 | 無論排程頻率如何，您都可以將已排程專案的最長過期日設定為最多一年後。 了解更多 | 不適用 | 2023 年 3 月 8 日 |
| 專案連結共用 (不需登入) - 僅限 Private beta 存取 | 您現在可以和無法存取 Customer Journey Analytics 的人員共用 Analysis Workspace 專案的唯讀連結了。 您可以與組織外的人員或組織內未佈建 Customer Journey Analytics 的人員共用專案連結。 如需如何加入 Private Beta 的詳細資訊，請聯絡您的 Adobe 客戶團隊。 | 2023 年 4 月 26 日 | 2023 年 6 月 |
| 面板日期範圍更新 | 在工作區中，我們新增了以下改善：<ul><li>從 2 月版開始，維度項目和資料預覽會依據面板日期範圍顯示，而不是顯示過去 90 天的內容。</li><li>列出的所有維度項目都是根據面板日期範圍內的資料顯示。 如果維度項目包含超出日期範圍的資料，您可以將超出日期範圍的額外資料顯示在清單底部。</li><li>沒有資料的維度可以顯示在左側邊欄中。 按一下「[!UICONTROL 顯示更多]」選項，查看面板日期範圍外資料的維度項目。</li><li>區段和計算量度產生器中的資料預覽都將依據面板日期範圍顯示 (除非從沒有關聯面板的元件管理員存取，則仍將依據過去 90 天)。</li><li>資料預覽將依據面板日期範圍顯示資料或元件。</li></ul> | 不適用 | 2023 年 2 月 8 日 |
