...
| **Edge Network 裝置查詢** | 透過 Experience Platform Edge Network 啟用自動裝置類型資料彙集。 此服務有利於 Customer Journey Analytics 以及其他 Experience Platform 應用程式。 [了解更多](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html?lang=zh-Hant#geolocation-device-lookup) | 不適用 | 2023 年 9 月 27 日 |
