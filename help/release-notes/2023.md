...
| **Analysis Workspace 中的資料字典** | 資料字典可協助使用者和管理員追蹤及更瞭解其Customer Journey Analytics環境中的元件（維度、量度）。 [了解更多](/help/components/data-dictionary/data-dictionary-overview.md) | 2023 年 3 月 8 日 | 2023 年 3 月 29 日 |
| **專案連結共用 (不需登入)** | <p>您現在可以與無 Adobe Analytics 存取權的人員共用 Analysis Workspace 專案的唯讀連結。這包括與您組織外部的人員或您組織內部未布建供Customer Journey Analytics的人員共用。 [了解更多](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/curate-share/share-projects.html?lang=en#share-public-link)</p> <p>此功能預設為啟用，系統管理員可以停用。[了解更多](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/user-preferences.html?lang=en#company-preferences)</p> | 2023 年 5 月 3 日 | 2023 年 6 月 |
| **Adobe Product Analytics - 僅限 Private Beta 存取權** | 2023 年 3 月 21 日，Adobe 宣布推出 Adobe Product Analytics，這是一種與 Customer Journey Analytics 跨管道資料和深入見解進行互動的新方式。這些新功能使產品團隊能夠透過引導式分析工作流程取得有關其產品體驗的自助資料和深入見解。團隊可以：<ul><li>了解一段時間內使用者參與模式&#x200B;</li><li>分析使用者群的增長</li><li>辨識一系列步驟中的摩擦區域&#x200B;</li><li>衡量功能發佈的影響&#x200B;</li><li>發現在產品整個歷程中可投入和培養的有意義巿場區間</li><li>在 Analysis Workspace 中開啟以進行更深入分析和與分析師協作等！</li></ul>如果您是Customer Journey Analytics客戶並有意加入私人測試版，請聯絡您的Adobe客戶團隊。 [了解更多](https://business.adobe.com/products/product-analytics/adobe-product-analytics.html) | 不適用 | 2023 年 7 月 17 日 |
...
| 功能 | 說明 | [開始推出](/help/release-notes/releases.md) | [全面發佈](/help/release-notes/releases.md) |
| ----------- | ---------- | ----- | --- |
| Analysis Workspace 中的資料字典 | 資料字典可協助使用者和管理員追蹤及更瞭解其Customer Journey Analytics環境中的元件（維度、量度）。 了解更多 | 2023 年 3 月 8 日 | 暫時無法使用 |
...
| 專案連結共用 (不需登入) - 僅限 Private beta 存取權 | 您現在可以與沒有Customer Journey Analytics存取許可權的人共用Analysis Workspace專案的唯讀連結。 您可以與組織外部的人員共用專案連結，或與組織內部未布建供Customer Journey Analytics的人員共用專案連結。 如需如何加入 Private Beta 的詳細資訊，請聯絡您的 Adobe 客戶團隊。 | 2023 年 4 月 26 日 | 2023 年 6 月 |
...
| 功能 | 說明 | [開始推出](/help/release-notes/releases.md) | [全面發佈](/help/release-notes/releases.md) |
| ----------- | ---------- | ----- | --- |
| **更新Customer Journey Analytics對象** | 建立受眾後，Adobe會為每個新Experience Platform受眾建立Customer Journey Analytics串流區段。 只有在組織設定為串流分段時，串流區段才會建立。[了解更多](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html#after-audience-created) | 不適用 | 2023 年 2 月 3 日 |
...
| 功能 | 說明 | [開始推出](/help/release-notes/releases.md) | [全面發佈](/help/release-notes/releases.md) |
| ----------- | ---------- | ----- | --- |
| **針對設定檔及查閱資料集提供物件陣列支援** | 設定檔資料集和查詢資料集現在支援在Customer Journey Analytics中使用的物件陣列。 | 2023 年 1 月 11 日 | 2023 年 1 月 19 日 |
