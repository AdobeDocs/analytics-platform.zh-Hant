...
| **支援Ad Hoc和關聯式結構描述** | [臨機](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/xdm/tutorials/ad-hoc)和[關聯式結構描述](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/schema/relational)用於Experience Platform的資料擷取和資料映象工作流程。 |  | 2025 年 9 月 23 日 (原規劃於 2025 年 8 月 28 日發行) |
