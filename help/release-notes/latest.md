...
| **支援Report Builder中的安全目的地** | 新的匯出目的地已新增至Report Builder增益集。 支援下列雲端儲存空間目的地： <ul><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> (文件連結待補充) |  | 18,2025 年 6 月 |
