...
| **B2B 範本** | 如果您擁有 Customer Journey Analytics B2B Edition 授權，則現在可以從 Adobe 範本 UI 使用下列其他 B2B 範本： <ul><li>B2B 帳戶參與度概觀</li><li>B2B 機會參與度概觀</li><li>B2B 購買群組活動</li></ul><p>(文件連結待補充。)</p> |  | 2025 年 8 月 15 日 |
