...
| **轉換B2B查詢資料集** | 您現在可以 [轉換B2B查詢資料集](/help/connections/transform-datasets-b2b-lookups.md) 定義連線時。 此轉換可支援對B2B資料進行以人員為基礎的查詢。 | | 2024年6月6日 |
...
| **衍生欄位 — 新函式和函式範本** | 其他衍生欄位函式([Math](/help/data-views/derived-fields/derived-fields.md#math)， [下一個或上一個](/help/data-views/derived-fields/derived-fields.md#next-or-previous))和 [函式範本](/help/data-views/derived-fields/derived-fields.md#function-templates). | | 2024 年 6 月 5 日 |
...
| **有關資料匯出使用案例的新檔案** | 這個新的章節大綱 [資料匯出使用案例](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/cja-usecases/data-export/overview) 例如<ul><li>資料備份</li><li>資料驗證</li><li>資料湖、Data Warehouse 或 BI 工具</li><li>為 AI/ML 做好準備</li></ul> 以及如何使用 Experience Platform 和 Customer Journey Analytics 功能來實施。 | | 現已提供 |
