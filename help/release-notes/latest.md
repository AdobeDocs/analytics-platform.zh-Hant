...
| ----------- | ---------- | ------- | ---- |
| **包含線上圖視覺效果和走勢圖中的篩選條件** | 您套用至自由表格篩選器的任何搜尋篩選條件，現在一律會包含在走勢圖中。 此外，您也可以將搜尋篩選條件納入任何連線的線條視覺效果中。<p>您可以選取所連線表格之量度欄標題中的走勢圖，將線條視覺效果設定為包含搜尋篩選條件。</p><p>以往，搜尋篩選條件不會包含在走勢圖或連線的線段視覺效果中。</p><p>如需詳細資訊，請參閱[檢視自由表格趨勢資料](/help/analysis-workspace/visualizations/freeform-table/freeform-table-trended-data.md)。</p> | | 2025 年 10 月 15 日 |
| **資料storytelling：從Workspace報表產生投影片簡報** | 您現在可以根據Analysis Workspace報告自動產生投影片簡報（採用.pptx格式）。 Workspace會偵測報表中的關鍵深入分析，並將其轉換為利害關係人就緒的投影片。<p>此功能可減少呈現發現、建立主管敘事及溝通業務影響所需的時間和精力。</p><p>(文件連結待補充。)</p> | 2025年10月22日 | 2026 年 1 月 |
| **即時報告** | Customer Journey Analytics 中的即時報告會即時顯示並更新 Analysis Workspace 中一個或多個面板內的資料和視覺化呈現內容。<br/><br/>(文件連結待補充。) | 2025 年 9 月 18 日 (原規劃於 2025 年 8 月 15 日發行) | 2025 年 10 月 27 日 |
