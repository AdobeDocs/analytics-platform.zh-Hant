...
| **支援臨時結構描述** | [臨時結構描述](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/xdm/tutorials/ad-hoc)會在 Experience Platform 的各種資料攝取工作流程中使用，包括攝取 CSV 檔案和建立特定種類的來源連線。 <p>此功能可支援在 Customer Journey Analytics 中使用臨時結構描述。現在起，您可以在連線定義時根據臨時結構描述選取資料集，並在資料視圖和工作區專案中使用該資料。</p> <p>(文件連結待補充。)</p> |  | 2025年9月23日（原計畫於2025年8月28日發行） |
| **即時報告** | [Customer Journey Analytics中的即時報告](/help/components/real-time/real-time.md)會即時顯示和更新Analysis Workspace中一個或多個面板內的資料和視覺效果。<br/> | 2025 年 9 月 18 日 (原規劃於 2025 年 8 月 15 日發行) | 2025年9月25日 |
