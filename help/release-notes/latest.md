...
| **CJA 的實驗面板 (一般提升度和信賴度)** | 此全新的工作區面板可讓 CJA 使用者評估任何來源的任何 A/B 實驗的提升度和信賴度 - 線上、離線、來自 Adobe 解決方案、Adobe Journey Optimizer，甚至 BYO 資料。如需詳細資訊，請前往。 | 2022 年 8 月 24 日 |
