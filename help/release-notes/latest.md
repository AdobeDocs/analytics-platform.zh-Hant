...
| **查閱鍵限制增加至 10 億** | 現在起，視您的 Customer Journey Analytics 授權而定，查詢資料集的唯一關鍵值數量上限可高達 10 億。 <p>之前，所有權限的數量上限都是 1000 萬。<p>如需詳細資料，請參閱[護欄](/help/technotes/guardrails.md)。</p> | | 2025年9月25日 |
| **支援Ad Hoc和模型架構** | [臨機](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/xdm/tutorials/ad-hoc)和模型架構用於Experience Platform的資料擷取和資料映象工作流程。 |  | 2025年9月23日（原計畫於2025年8月28日發行） |
| **即時報告** | Customer Journey Analytics 中的即時報告會即時顯示並更新 Analysis Workspace 中一個或多個面板內的資料和視覺化呈現內容。<br/><br/>(文件連結待補充。) | 2025 年 9 月 18 日 (原規劃於 2025 年 8 月 15 日發行) | 2025年10月1日 |
| **支援 Data Mirror** | 透過Experience Platform中特定來源聯結器的模型型結構描述和變更資料擷取(CDC)功能支援，Customer Journey Analytics將能支援[!DNL Snowflake]、[!DNL Azure Databrick]和[!DNL Google BigQuery]等資料倉儲解決方案的資料映象功能。<p>若要存取 Beta 版，請聯絡您的 Adobe 帳戶團隊。</p><p>(文件連結待補充。)</p> | Beta於2025年9月24日起發行 | 待定 |
