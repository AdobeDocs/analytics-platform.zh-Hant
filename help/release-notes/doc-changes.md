...
| --- | --- |
| **2023 年 6 月** |  |
| 計算量度更新 | 已對計算量度檔案進行下列更新，以便使其與目前的CJA功能相符： <ul><li>更新以下專案的清單： [預設計算量度](/help/components/calc-metrics/default-calcmetrics.md) 在CJA中提供</li><li>更新各種計算量度文章中的熒幕擷取畫面和程式 </li></ul> |
| **2023 年 5 月** |  |
...
| --- | --- |
| **2021 年 11 月** |  |
| 2021 年 11 月 | 「連線詳細資料」頁面「[[!UICONTROL 略過的記錄]](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=zh-Hant)」更新文件。 |
| **2021 年 10 月** |  |
