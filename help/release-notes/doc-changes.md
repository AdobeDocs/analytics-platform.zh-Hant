...
| --- | --- |
| **2025 年 9 月** | |
| 內容標籤 | 已新增資料檢視元件中[內容標籤](/help/data-views/component-settings/overview.md#context-labels)的使用與用途的背景資訊。 |
| **2025 年 8 月** | |
| 與Adobe Advertising的新整合 | 已新增有關[與Adobe Advertising](/help/integrations/advertising.md)整合的資訊。 |
