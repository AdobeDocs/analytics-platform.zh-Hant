...
| Mobile 計分卡 | 新文件部分會說明如何顯示和隱藏比較日期範圍。查看 CIA 內的[顯示比較日期範圍](/help/mobile-app/create-scorecard.md#show-comparison-dates)。 |
| **2023 年 1 月** | |
...
| 針對設定檔及查閱資料集提供物件陣列支援 | 已更新[使用物件陣列](/help/use-cases/object-arrays.md)和[擷取 AEP 對象](/help/use-cases/data-ingestion/ingest-aep-segments.md)，以反映針對設定檔及查閱資料集的物件陣列支援 |
...
| 2022 年 4 月 | 最新[Adobe Analytics 使用者的 CJA 使用手冊](/help/getting-started/aa-to-cja-user.md)。 |
| **2022 年 3 月** | |
...
| **2022 年 2 月** | |
| 2022 年 2 月 | 適用於從 Adobe Analytics 移至 CJA 的新管理員指南：[Adobe Analytics 至 Customer Journey Analytics 的發展進程](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/aa-to-cja.html?lang=zh-Hant) |
| **2022 年 1 月** | |
...
| 2022 年 1 月 | [將您的 Adobe Analytics 資料與 CJA 中的 Analytics 資料進行比較](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html?lang=zh-Hant)的新文章 |
...
| **2021 年 10 月** | |
| 2021 年 10 月 | 完成 CJA 中 [Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/report-buider-overview.html?lang=zh-Hant#) 的文件。 |
...
| 2021 年 9 月 | 有關 CJA 中[合併報告套裝的影響](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=zh-Hant#6.-considerations-when-merging-report-suites-in-cja)的新章節。 |
| **2021 年 8 月** | |
| 2021 年 8 月 | 有關 CJA 中強化[連線](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=zh-Hant)體驗的新章節。 |
