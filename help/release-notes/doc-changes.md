...
| **2026 年 3 月** | |
| 劃分面板 | 已重新建構面板[的](/help/analysis-workspace/c-panels/panels.md#drop-zone)拖放區域檔案，以支援新的[劃分](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel)功能。 |
| 錯誤ID (BAVID)的技術檔案 | 錯誤ID[上的新](/help/technotes/badids.md)技術檔案。 此技術檔案說明了「錯誤ID」的定義（在Customer Journey Analytics介面中使用了「錯誤ID」），以及如何調查連線中的資料是否有「錯誤ID」。 |
...
| 計算量度護欄 | 已更新組織[的最大計算量度數的](/help/technotes/guardrails.md#segments-and-calculated-metrics)護欄。 目前的上限為50,000。 |
| 獨立Content Analytics | 新增Content Analytics[的](/help/content-analytics/config/standalone.md)獨立組態檔案。 |
| **2026 年 1 月** | |
...
| --- | --- |
| **2025 年 12 月** | |
| 沙箱變更的影響 | 新增沙箱刪除或重設到[刪除和重設的關聯](/help/technotes/deletion.md)文章的關聯。 |
| **2025 年 11 月** | |
