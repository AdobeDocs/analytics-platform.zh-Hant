...
| --- | --- |
| **2025 年 9 月** | |
| 1900年之前的日期 | 已新增[備註](/help/connections/create-connection.md#datasets)，說明Customer Journey Analytics處理1900年之前的日期的方式。 |
| 即時報告 | 新增有關Customer Journey Analytics中[即時報告](/help/components/real-time/real-time.md)的檔案。 |
