...
| --- | --- |
| **2026 年 1 月** | |
| 每年連線中的列護欄 | 已新增資料傳輸限制[的](/help/technotes/guardrails.md)護欄資訊，瞭解連線中每年的最大平均列數。 |
| 檢視儲存資料的資料中心 | 已新增儲存資料的資料中心的[相關資訊](/help/technotes/data-centers.md#view-the-data-center-where-your-data-is-stored)。 |
...
| 報告活動管理員 | 新增報告活動管理器的文件。 <p>報告活動管理器可讓您查看組織中每個連線的報告容量。它為管理員提供報告使用量的詳細可見度，以便在尖峰報告時段輕鬆診斷和修正容量問題。</p> <p>已新增下列新文章：<ul><li>[報告活動管理器概觀](/help/reporting-activity-manager/reporting-activity-overview.md)</li><li>[在報告活動管理器中檢視報告活動](/help/reporting-activity-manager/reporting-activity.md)</li><li>[在報告活動管理器中取消請求](/help/reporting-activity-manager/reporting-activity-cancel-requests.md)</ul> |
...
| 2022 年 1 月 | 新增有關[比較 Adobe Analytics 資料與 Customer Journey Analytics 中的 Analytics 資料](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html?lang=zh-Hant)的文章 |
