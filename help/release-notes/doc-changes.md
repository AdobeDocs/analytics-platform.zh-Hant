...
|---|---|
| **2026年5月** | |
| Content Analytics的標籤不可知設定 | [檔案](/help/content-analytics/config/tags-agnostic.md)說明如何為網路通道實作Content Analytics，而不需要Experience Platform資料收集標籤。 |
...
| 術語變更：將「篩選器」更改為「區段」 | 先前，Adobe Customer Journey Analytics 將區段稱為「篩選器」。 該術語現已與 Adobe Analytics 維持一致。 「篩選器」現稱為「區段」。 （顯然，搜尋篩選器仍稱為「篩選器」。） 已更新UI和檔案。 |
| **2025 年 3 月** | |
