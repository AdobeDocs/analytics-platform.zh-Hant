...
| 授予Adobe Azure應用程式金鑰存取權的替代方法 | 新增在[在Azure上為Customer Journey Analytics設定客戶管理的金鑰](/help/privacy/cmk.md#set-up-customer-managed-keys-for-customer-journey-analytics-on-azure)時，透過授權同意授與許可權的資訊。 |
| **2025 年 6 月** | |
