...
| --- | --- |
| **2025 年 9 月** | |
| 使用介面 | 已新增連線中已更新[使用方式介面](/help/connections/manage-connections.md#usage)的檔案。 |
| 彙整Journey Optimizer資料集 | 以檔案說明可用於拼接的自動產生Journey Optimizer資料集[的](/help/stitching/overview.md#journey-optimizer-datasets)清單。 |
| 環境標籤 | 針對資料視圖元件中的[環境標籤](/help/data-views/component-settings/overview.md#context-labels)之使用方法和用途，新增更多背景資訊。 |
| **2025 年 8 月** | |
| Adobe Advertising 的新整合 | 新增[與 Adobe Advertising 整合](/help/integrations/advertising.md)的資訊。 |
