...
| --- | --- |
| **2025 年 10 月** | |
| LLM和AI產生的流量報告 | 已新增有關如何使用衍生欄位做為基礎來報告LLM和AI產生的流量的[使用案例文章](/help/use-cases/ai-traffic.md)。 文章是以部落格[在Adobe Customer Journey Analytics中追蹤和分析LLM和AI產生的流量](https://experienceleaguecommunities.adobe.com/t5/adobe-analytics-blogs/tracking-and-analyzing-llm-and-ai-generated-traffic-in-adobe/ba-p/771967)為基礎。 |
| **2025 年 9 月** | |
