...
| 日期 | 更新說明 |
| --- | --- |
| 2022 年 4 月 | 新建 [CJAAdobe Analytics使用手冊](/help/getting-started/aa-to-cja-user.md)。 |
| 2022 年 3 月 | 新建 [CJA注釋API文檔](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/)。 |
| 2022 年 3 月 | 有關 [工作區中的注釋](/help/components/annotations/overview.md)。 |
| 2022 年 3 月 | 顯著更新內容 [估計連接大小](/help/getting-started/cja-faq.md)。 |
| 2022 年 2 月 | [Adobe Analytics對Customer Journey Analytics進化](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/aa-to-cja.html) |
...
| 2021 年 11 月 | 「連線詳細資料」頁面「[[!UICONTROL 略過的記錄]](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html#connection-details-settings)」更新文件。 |
...
| 2021 年 10 月 | [!UICONTROL 連線][資料保留](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html#set-rolling-window-for-connection-data-retention)滾動時段的文件。<p>**注意：請聯絡客戶服務或您的 Adobe 客戶經理，以實作此項設定。尚未透過 CJA UI 提供。** |
...
| 2021 年 9 月 | 有關 CJA 中[合併報表套裝的影響](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html#6.-considerations-when-merging-report-suites-in-cja)的新區段。 |
