...
Customer Journey Analytics檔案自建立以來已進行下列更新。
...
| --- | --- |
| **2023 年 6 月** | |
| 跨管道分析和拼接 | 為因應即將推出的啟用銜接的變更，以及進一步釐清如何使用銜接來提升跨管道分析的許可權，我們將編輯與跨管道分析功能相關的檔案，以參照 [跨頻道分析](../use-cases/cross-channel/cross-channel.md) 作為Customer Journey Analytics功能和使用案例，以及 [拼接](../stitching/overview.md) 作為完成此專案的重要功能。 |
...
| 計算量度更新 | 已對計算量度檔案進行下列更新，以使其與目前的Customer Journey Analytics功能相符： <ul><li>更新以下專案的清單： [預設計算量度](/help/components/calc-metrics/default-calcmetrics.md) 可在Customer Journey Analytics中使用</li><li>已更新各種計算量度文章中的螢幕擷取畫面和程序 </li></ul> |
| **2023 年 5 月** | |
...
| 最佳化更新 | 更新文章： [最佳化Customer Journey Analytics效能](/help/admin/optimizing-performance.md) |
...
| **2023 年 3 月** | |
| 整合決策管理資料 | 已新增說明如何進行 [在Customer Journey Analytics中整合Adobe Journey Optimizer決定管理資料](/help/integrations/ajo-od.md). |
| 在行動計分卡中建立資料故事 | [資料故事](/help/mobile-app/create-scorecard.md#create-data-stories)是圍繞中心主題或量度建置的支援資料點、業務內容和相關量度的集合。 |
| 更新功能支援 | 已更新 [Customer Journey Analytics功能支援](/help/getting-started/aa-vs-cja/cja-aa.md) 包含Customer Journey Analytics中可用但AA中不可用或支援的功能表格。 |
...
| 更新至 Audiences 文件 | 建立受眾後，Adobe會建立Experience Platform [每個新Customer Journey Analytics對象的串流區段](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html?lang=zh-Hant#after-audience-created). |
...
| Mobile 計分卡 | 新文件部分會說明如何顯示和隱藏比較日期範圍。另請參閱 [顯示比較日期範圍](/help/mobile-app/create-scorecard.md#show-comparison-dates) 在Customer Journey Analytics中。 |
| **2023 年 1 月** | |
...
| 資料擷取快速入門指南 | 新增說明檔案區段，說明如何 [擷取及使用資料](/help/data-ingestion/data-ingestion.md) 在Customer Journey Analytics中。 |
...
| 針對設定檔及查閱資料集提供物件陣列支援 | 已更新 [使用物件陣列](/help/use-cases/object-arrays.md) 和 [擷取Adobe Experience Platform對象](/help/use-cases/data-ingestion/ingest-aep-segments.md) 以反映物件陣列對設定檔和查詢資料集的支援。 |
...
| --- | --- |
| **2022 年 12 月** |  |
| 2022 年 12 月 16 日 | 有關的新主題 [測量及管理您的Customer Journey Analytics資料使用情況](/help/admin/estimate-usage.md). |
| **2022 年 10 月** | |
...
| 2022 年 10 月 | 有關的新主題 [Customer Journey Analytics稽核記錄](/help/privacy/audit-log.md). |
...
| **2022 年 9 月** | |
| 2022 年 9 月 | 上的新使用案例 [將Google Analytics資料移轉至Customer Journey Analytics](/help/use-cases/ga/overview.md). |
...
| 2022 年 8 月 | 有關的重要更新文章 [Customer Journey Analytics存取控制](/help/admin/cja-access-control.md). |
| 2022 年 8 月 | 上的新文章 [Customer Journey Analytics支援資料控管標籤和原則](/help/data-views/data-governance.md). |
...
| **2022 年 6 月** | |
| 2022 年 6 月 | 關於 [AAID、ECID、ACUSTOMID 和分析來源連接器](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/cja-aa-comparison/aaid-ecid-adc.html?lang=zh-Hant)的新文章 |
...
| 2022 年 6 月 | 上的新文章 [比較Adobe Analytics與Customer Journey Analytics報告功能的資料處理](/help/getting-started/aa-vs-cja/data-processing-comparisons.md). |
...
| 2022 年 6 月 | 上的新文章 [Customer Journey Analytics中的Analytics Labs](/help/labs/labs.md). |
...
| **2022 年 5 月** | |
| 2022 年 5 月 | 有關的重要更新文章 [建立連線](/help/connections/create-connection.md) 在Customer Journey Analytics中。 |
| 2022 年 5 月 | 新文章，說明如何進行 [管理Customer Journey AnalyticsReport Builder中的資料區塊](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/manage-reportbuilder.html?lang=zh-Hant). |
| 2022 年 5 月 | 上的新文章 [將Adobe Experience Platform受眾擷取至Customer Journey Analytics](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **2022 年 4 月** | |
...
| 2022 年 4 月 | 新增 [Adobe Analytics使用者的Customer Journey Analytics使用指南](/help/getting-started/aa-to-cja-user.md). |
| **2022 年 3 月** | |
| 2022 年 3 月 | 新增 [Customer Journey Analytics註解API檔案](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/). |
...
| **2022 年 2 月** | |
| 2022 年 2 月 | 適用於從Adobe Analytics移轉至Customer Journey Analytics之管理員的新指南： [Adobe Analytics到Customer Journey Analytics的演化](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/aa-to-cja.html?lang=zh-Hant) |
| **2022 年 1 月** | |
| 2022 年 1 月 | 的新使用案例 [在Customer Journey Analytics中使用繫結維度和量度](/help/use-cases/data-views/binding-dimensions-metrics.md) |
| 2022 年 1 月 | 新增關於[繫結維度和量度](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/persistence.html?lang=zh-Hant#binding-dimension)，以及新的[[!UICONTROL 最先已知]和[!UICONTROL 最後已知]配置設定](/help/data-views/component-settings/persistence.md#allocation-settings)的新功能文件 |
| 2022 年 1 月 | 上的新文章 [將您的Adobe Analytics資料與Customer Journey Analytics中的Analytics資料進行比較](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html?lang=zh-Hant) |
...
| --- | --- |
| **2021 年 11 月** | |
| 2021 年 11 月 | 「連線詳細資料」頁面「[[!UICONTROL 略過的記錄]](/help/connections/manage-connections.md)」更新文件。 |
| **2021 年 10 月** | |
| 2021 年 10 月 | 檔案： [Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/report-buider-overview.html?lang=zh-Hant#) 在Customer Journey Analytics中。 |
...
| 2021 年 9 月 | 上的新區段 [合併報表套裝的影響](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=zh-Hant#6.-considerations-when-merging-report-suites-in-cja) 在Customer Journey Analytics中。 |
| **2021 年 8 月** | |
| 2021 年 8 月 | 有關增強功能的新區段 [連線](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=zh-Hant) Customer Journey Analytics體驗。 |
...
| 2021 年 4 月 | 有關的新主題 [Customer Journey Analytics中的高基數維度](/help/components/dimensions/high-cardinality.md). |
| **2021 年 3 月** | |
...
| 2021 年 2 月 | 已發佈新的 [CUSTOMER JOURNEY ANALYTICSAPI](https://www.adobe.io/cja-apis/docs/) 說明檔案。 |
| **2021 年 1 月** | |
...
| 2019 年 12 月  | Customer Journey Analytics檔案初稿 |
