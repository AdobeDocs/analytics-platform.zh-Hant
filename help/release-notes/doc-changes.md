...
| 2022 年 6 月 | 更新到 [流可視化工作流](/help/analysis-workspace/visualizations/c-flow/create-flow.md) |
| 2022 年 6 月 | 有關 [訪問群體發佈到即時客戶配置檔案](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/audiences-overview.html) |
...
| 2022 年 2 月 | 針對從Adobe Analytics遷至CJA的管理員的新指南： [Adobe Analytics對Customer Journey Analytics進化](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/aa-to-cja.html?lang=zh-Hant) |
