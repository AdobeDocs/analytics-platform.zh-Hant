...
| 功能 | 說明 | 螢幕擷圖 |
| --- | --- | --- |
| 展開[!UICONTROL 專案]表格至全螢幕 | 若要展開表格，僅需按一下漢堡選單圖示。這個動作將收合左側欄索引標籤。 | ![展開選取的表格，只顯示沒有左側欄索引標籤的專案](assets/landing-collapse2.png) |
| 自訂欄寬 | 以前欄寬是固定的。現在您可以透過拖曳欄分隔元來調整它。 | ![欄寬選取器](assets/column-width.png) |
