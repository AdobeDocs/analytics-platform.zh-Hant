...
## &#x200B;3. 正在將資料帶入[!UICONTROL Customer Journey Analytics] {#ingest}
...
+++**我可以將[!UICONTROL 個對象]從[!DNL Customer Journey Analytics]共用/發佈到Experience Platform Real-Time CDP或其他CX Enterprise應用程式嗎？**
