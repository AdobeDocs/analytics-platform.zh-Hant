...
| **步驟2： [選擇移轉方法](/help/getting-started/cja-migration/cja-migration-method.md)** | 有多種方法可用來移轉至Customer Journey Analytics。 選擇最適合您組織的方法，並考量您組織目前的Adobe Analytics環境和您的長期目標。 |
