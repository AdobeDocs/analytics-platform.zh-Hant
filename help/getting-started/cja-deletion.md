...
| 刪除 [!UICONTROL Adobe Experience Platform] 中的查閱資料集 | 雖然可以刪除其他源連接器的資料集，但當前不支援 [分析分類源連接器](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/classifications.html)。 如果您誤刪了資料集，請聯絡 Adobe 客戶服務。 |
