...
>abstract="因為您選取執行實作捷徑，故顯示此步驟。 複製或變更 AppMeasurement 邏輯以填入資料物件，而非 s 物件。 例如，將 s.eVar1 的指派變更為 data.__adobe.analytics.eVar1，並對所有 Analytics 變數重複此步驟。"
...
1. 移轉您的Adobe Analytics實作以使用Adobe Experience Platform Web SDK，並開始將資料傳送至Edge Network。
   ...
   * [使用標記移轉至 Web SDK](https://experienceleague.adobe.com/zh-hant/docs/analytics/implementation/aep-edge/web-sdk/analytics-extension-to-web-sdk)

   * [使用 JavaScript 移轉至 Web SDK](https://experienceleague.adobe.com/zh-hant/docs/analytics/implementation/aep-edge/web-sdk/appmeasurement-to-web-sdk)
