...
Adobe Analytics客戶可以輕鬆在Adobe Experience Platform中運用其報表套裝，並使用Customer Journey Analytics [Analytics來源聯結器](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html?lang=zh-Hant). 下面的討論內容將說明如何這樣做。

>[!IMPORTANT]
>
>您必須擁有 **選取** 套裝，以便對多個報表套裝執行資料分析。 如果您不確定您擁有哪個Customer Journey Analytics套件，請聯絡管理員。&#x200B;
