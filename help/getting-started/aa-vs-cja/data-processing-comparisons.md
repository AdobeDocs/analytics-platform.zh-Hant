...
| 訪客層級邏輯 | 在人員層級套用的邏輯。 | 範例：跨裝置/跨管道人員拼接。 |
| 區段邏輯 | 評估事件/造訪/個人 (事件/工作階段/個人) 區段規則。 | 範例：買紅鞋子的人。 |
...
長期下來，Adobe Analytics 和現在的 Customer Journey Analytics 允許在報告執行階段執行造訪和個人層級的資料邏輯，因此提高了靈活性。
...
| --- | --- | --- | --- | --- |
| [Adobe Analytics](https://experienceleague.adobe.com/zh-hant/docs/analytics)報告<br/> （不包括進階歸因功能或具有報告時間處理功能的虛擬報告套裝） | <ul><li>[處理規則](https://experienceleague.adobe.com/zh-hant/docs/analytics/admin/admin-tools/manage-report-suites/edit-report-suite/report-suite-general/c-processing-rules/processing-rules)</li><li>[VISTA 規則](https://experienceleague.adobe.com/zh-hant/docs/analytics/technotes/terms)</li><li>點擊層級的[行銷管道規則](https://experienceleague.adobe.com/zh-hant/docs/analytics/admin/admin-tools/manage-report-suites/edit-report-suite/marketing-channels/c-rules)</li><li>造訪層級的行銷管道規則 (請見附註)</li><li>造訪定義</li><li>歸因邏輯</li></ul> | <ul><li>區段邏輯</li><li>計算量度</li></ul> | <ul><li>跨裝置分析 (請見附註)</li></ul> | <ul><li>跨裝置分析需要使用具有報表時間處理功能的虛擬報表套裝。</li><li>「造訪層級的行銷管道規則」包括以下項目：**是第一個造訪的頁面**、**覆寫最近一次接觸頻道**&#x200B;和&#x200B;**行銷管道期限**。 (請參閱[文件](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/cja-usecases/aa-data/marketing-channels))。</li></ul> |
...
| Adobe Analytics [資料摘要](https://experienceleague.adobe.com/zh-hant/docs/analytics/export/analytics-data-feed/data-feed-overview) | <ul><li>處理規則</li><li>VISTA 規則</li><li>點擊層級的行銷管道規則</li><li>造訪層級的行銷管道規則</li><li>造訪定義 (visitnum 欄位)</li><li>歸因邏輯 (在後置欄中)</li></ul> |   | <ul><li>區段邏輯</li><li>計算量度</li><li>跨裝置分析</li></ul> | <ul><li>資料摘要中某些與行銷管道相關欄位的 ID 對應不包含在資料摘要中。 (請參閱[資料摘要文件](https://experienceleague.adobe.com/zh-hant/docs/analytics/export/analytics-data-feed/data-feed-contents/datafeeds-reference))。</li></ul> |
