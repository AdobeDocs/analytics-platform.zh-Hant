...
>[!IMPORTANT]
>標準查找僅適用於CJA中的分析源連接器資料源。 您可以將其用於標準 Adobe Analytics 實施、[Adobe Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html) 或 Experience Platform 資料收集 API。
...
標準查詢資料集會在報表時間自動套用。 如果使用分析源連接器並引入Adobe提供標準查找的維，則我們將自動應用此標準查找。 如果事件資料集包含 XDM 欄位，我們就能為該資料集套用標準查詢。
