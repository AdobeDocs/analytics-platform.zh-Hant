...
>title="法律影響"
>abstract="根據整合資料量，使用Customer Journey Analytics可能會導致其他變更。 檢視[有關Customer Journey Analytics帳單和使用情況的詳細資料](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/cja-connections/manage-connections#connections-usage)"
