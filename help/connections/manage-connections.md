...
| **[!UICONTROL 結構描述]** | 資料集所根據的Experience Platform結構描述。 |
...
| **[!UICONTROL 轉換資料]** | 適用的B2B查詢資料集的轉換狀態。 請參閱[轉換資料集以進行 B2B 查詢](transform-datasets-b2b-lookups.md)，了解更多資訊。<p>![狀態綠色](assets/status-green.svg)   **[!UICONTROL _x _On]**啟用轉換的資料集數目。 |
